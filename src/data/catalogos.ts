...
export const articulos: Articulo[] = [
  ...
  },
  {
    id: 'art-168-4-2',
    codigo: '168-4(2)',
    nombre: 'Art. 168-4(2) - Operación de Salida',
    descripcion: 'Contrabando en operaciones de salida con agravantes del numeral 4 inciso 2',
    tipoArticulo: 'Infraccional',
    permiteAllanamiento: false,
    normaLegal: 'Ordenanza de Aduanas Art. 168-4 inciso 2',
    vigente: true,
  },
  {
    id: 'art-169',
  ...
  },
  {
    id: 'art-169-2',
    codigo: '169-2',
    nombre: 'Art. 169-2 - Declaración Maliciosa',
    descripcion: 'Declaraciones maliciosamente falsas y falsificación de certificados o análisis',
    tipoArticulo: 'Infraccional',
    permiteAllanamiento: false,
    normaLegal: 'Ordenanza de Aduanas Art. 169 N°2',
    vigente: true,
  },
  {
    id: 'art-173',
    codigo: '173',
    nombre: 'Art. 173 - Manifiesto y Documentos Asociados',
    descripcion: 'Errores en manifiesto y documentos de destinación asociados',
    tipoArticulo: 'Infraccional',
    permiteAllanamiento: true,
    porcentajeAllanamiento: 20,
    normaLegal: 'Ordenanza de Aduanas Art. 173',
    vigente: true,
  },
  {
    id: 'art-174',
  ...
  },
  {
    id: 'art-176-o',
    codigo: '176-O',
    nombre: 'Art. 176-O - Clasificación Incorrecta Especial',
    descripcion: 'Clasificación incorrecta con tratamiento especial (letra O)',
    tipoArticulo: 'Infraccional',
    permiteAllanamiento: false,
    normaLegal: 'Ordenanza de Aduanas Art. 176 letra O',
    vigente: true,
  },
  {
    id: 'art-176-p',
    codigo: '176-P',
    nombre: 'Art. 176-P - Clasificación Incorrecta Especial',
    descripcion: 'Clasificación incorrecta con tratamiento especial (letra P)',
    tipoArticulo: 'Infraccional',
    permiteAllanamiento: false,
    normaLegal: 'Ordenanza de Aduanas Art. 176 letra P',
    vigente: true,
  },
  {
    id: 'art-176-q',
    codigo: '176-Q',
    nombre: 'Art. 176-Q - Clasificación Incorrecta Especial',
    descripcion: 'Clasificación incorrecta con tratamiento especial (letra Q)',
    tipoArticulo: 'Infraccional',
    permiteAllanamiento: false,
    normaLegal: 'Ordenanza de Aduanas Art. 176 letra Q',
    vigente: true,
  },
  {
    id: 'art-176-nn',
    codigo: '176-NN',
    nombre: 'Art. 176-NN - Clasificación Incorrecta',
    descripcion: 'Clasificación incorrecta con reglas específicas (NN)',
    tipoArticulo: 'Infraccional',
    permiteAllanamiento: false,
    normaLegal: 'Ordenanza de Aduanas Art. 176 NN',
    vigente: true,
  },
  {
    id: 'art-177',
  ...
  },
  {
    id: 'art-ozono',
    codigo: 'OZONO',
    nombre: 'Art. OZONO - Sustancias que agotan la capa de ozono',
    descripcion: 'Infracciones relacionadas con sustancias que agotan la capa de ozono',
    tipoArticulo: 'Infraccional',
    permiteAllanamiento: false,
    normaLegal: 'Normativa ambiental aplicable',
    vigente: true,
  },
  // Artículos Penales
  {
    id: 'art-pen-168bis',
    codigo: 'PEN-168BIS',
    nombre: 'Art. 168 bis - Contrabando Penal',
    descripcion: 'Contrabando que constituye delito penal (art. 168 bis)',
    tipoArticulo: 'Penal',
    permiteAllanamiento: false,
    normaLegal: 'Código Penal Art. 168 bis',
    vigente: true,
  },
  {
    id: 'art-pen-182',
    codigo: 'PEN-182',
    nombre: 'Art. 182 - Acciones sobre mercancías objeto de contrabando',
    descripcion: 'Acciones posteriores sobre mercancías objeto de contrabando',
    tipoArticulo: 'Penal',
    permiteAllanamiento: false,
    normaLegal: 'Ordenanza de Aduanas Art. 182',
    vigente: true,
  },
  {
    id: 'art-pen-18480',
    codigo: 'PEN-18480-18708',
    nombre: 'Reintegros indebidos (Ley 18.480 / 18.708)',
    descripcion: 'Reintegros y beneficios indebidamente obtenidos',
    tipoArticulo: 'Penal',
    permiteAllanamiento: false,
    normaLegal: 'Leyes 18.480 y 18.708',
    vigente: true,
  },
  {
    id: 'art-pen-168',
...
export const tiposInfraccion = [
  ...
  { id: 'ti-010', codigo: 'CONTRABANDO_PENAL', nombre: 'Contrabando Penal' },
  { id: 'ti-011', codigo: 'FALSIF_PENAL', nombre: 'Falsificación Documental Penal' },
  { id: 'ti-012', codigo: 'EVASION_PENAL', nombre: 'Evasión Tributaria Penal' },
  { id: 'ti-013', codigo: 'ACC_CONTRABANDO', nombre: 'Acciones sobre mercancías objeto de contrabando' },
  { id: 'ti-014', codigo: 'REINTEGROS', nombre: 'Reintegros Tributarios' },
];
