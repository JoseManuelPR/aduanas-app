...
export const denuncias: Denuncia[] = [
  ...
  },
  {
    ...
    numeroInterno: "INT-2025-001527",
    fechaIngreso: "24-11-2025",
    fechaEmision: "24-11-2025",
    fechaOcurrencia: "20-11-2025",
    estado: "Notificada",
    tipoDenuncia: "Infraccional",
    aduana: "Valparaíso",
    ...
    nombreDeudor: "Comercial del Pacífico Ltda.",
    tipoInfraccion: "Valor Incorrecto",
    codigoArticulo: "177",
    etapaFormulacion: "NOTIFICACION",
    montoEstimado: "$6.800.000",
    multa: 3500000,
    multaMaxima: 15000000,
    montoDerechos: 6800000,
    codigoMoneda: "CLP",
    autodenuncio: false,
    retencion: false,
    mercanciaAfecta: false,
    observada: false,
    descripcionHechos: "Se detectó una diferencia en el valor declarado de mercancías importadas. El valor FOB declarado fue de $45.000 USD cuando el valor real según factura comercial y análisis de mercado corresponde a $52.000 USD, resultando en un menor pago de derechos aduaneros por un monto de $6.800.000 CLP.",
    fundamentoLegal: "Ley 18.525 Art. 12",
    normaInfringida: "Art. 177 Ordenanza de Aduanas",
    mercanciaDescripcion: "Equipos de telecomunicaciones - Antenas y repetidores",
    involucrados: [
      {
        id: "inv-010",
        tipoInvolucrado: "Infractor Principal",
        rut: "77.234.567-8",
        nombre: "Comercial del Pacífico Ltda.",
        direccion: "Av. Errázuriz 2345, Valparaíso",
        email: "contacto@comercialpacifico.cl",
        telefono: "+56 32 2789012",
    ...
    documentosAduaneros: [
      {
        id: "doc-adu-005",
        tipoDocumento: "DIN",
        numeroDocumento: "6020-24-0098765",
        numeroAceptacion: "2024-11-20-009876",
        fecha: "20-11-2025",
        aduana: "Valparaíso",
        descripcion: "Declaración de Ingreso - Equipos de telecomunicaciones",
      },
    ],
    documentosAdjuntos: [
      { id: "doc-010", nombre: "factura_comercial.pdf", tipo: "pdf", tamanio: "1.5 MB", fechaSubida: "24-11-2025" },
      { id: "doc-011", nombre: "analisis_valor.pdf", tipo: "pdf", tamanio: "2.1 MB", fechaSubida: "24-11-2025" },
    ],
    loginFuncionario: "jrodriguez",
    loginFiscalizador: "jrodriguez",
    diasVencimiento: 8,
