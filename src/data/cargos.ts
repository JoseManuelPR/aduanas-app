...
export const cargos: Cargo[] = [
  ...
  },
  {
    ...
    codigoAduana: "ARI",
    codigoSeccion: "S-FIS",
    rutDeudor: "82.159.357-2",
    nombreDeudor: "Comercializadora Norte Grande SpA",
    norma: "OA-1",
    fundamento: "F-173-1",
    descripcionHechos: "Diferencia de clasificación arancelaria en productos electrónicos.",
